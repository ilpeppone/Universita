...
INSERT INTO Clienti (codfisc, nome, cognome, indirizzo, telefono)
VALUES  ('FRRLCI01T55F385O', 'Anna', 'Rossi','Via spade 5',null),
...
INSERT INTO Uffici (nome, citta, indirizzo)
VALUES  ('PostOne','Milano', 'Via cigni 12'),
        ('PosteItaliane','Milano', 'Via pesci 25'),
        ('SuperPoste','Ferrara', 'Via aquila 1');
 
INSERT INTO Pacchetti (id, cf_mittente, indirizzo_dest, tracking_number, peso, Nufficio)
VALUES  (1, 'FRRLCI01T55F385O', 'via della torre 12', 1345, 4.56, 'PostOne'),
...
INSERT INTO Impiegati (cf, nome, cognome, data_inizio_lavoro, salario, Nufficio)
VALUES  ('FRRLCI01T55F398O', 'Anna', 'Ricci','2021-05-12',20000,'PostOne'),
